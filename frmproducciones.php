...
$query="SELECT Id,Fecha,Cantidad,Tipoproducto,IdProducto FROM producciones";
  ...
  <div class="container my-3">
    <div class="row">
      <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
        <h2 class="centrado">Formulario de Producción</h2>

        <form action="registrarproduccion.php" method="post">

          <!-- <div class="form-group">
            <label for="id">Id:</label>
            <input type="number" name="Id" id="id" class="form-control" required placeholder="Id" autofocus>
          </div> -->
          <div class="form-group">
