...
<body class="p-3 m-0 border-0 bd-example" style="background-color: #FAF0E6;">
  ...
  <div class="container">
    ...
    <br>
    <h2 style="text-align: center;">Tabla Productos</h2>
    <tr>
      <table class="table">
    ...
    if (isset($_GET['btns'])) {
      ...
      $query = "SELECT * FROM productos WHERE Codigo LIKE '$Buscar' or Nombre LIKE '$Buscar'";
      ...
      if (mysqli_num_rows($conn) > 0) {
        while ($vec = mysqli_fetch_array($conn)) { ?>
          <tr>
            ...
            <td>
              <a href='actualizarproductos.php?Codigo=<?php echo $vec[0] ?>'><i class="fa-solid fa-pen-to-square"></i></a>
              <a href='EliminarProducto.php?Codigo=<?php echo $vec[0] ?>'><i class="fa-sharp fa-solid fa-trash"></i></i></a>
            </td>
          </tr>
    <?php }
      } else {
