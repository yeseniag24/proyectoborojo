  ...
  <div class="container">
    ...
    <form action="" method="post">
      <div class="row">
        ...
        <br>
        <div class="col-md-8">
          <input type="number" class="form-control" placeholder="Id Existencia" name="IdExistencia">
        </div>
        <br>
        <br>
        <div class="col-md-8">
          <input type="number" class="form-control" placeholder="Id Produccion" name="IdProduccion">
        </div>
        <br>
        <br>
        <div class="col-12">
