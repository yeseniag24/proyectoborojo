  ...
  <div class="container my-3">
    <div class="row">
      <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
        <h2 class="centrado">Formulario de Productos</h2>

        <form action="registrarproductos.php" method="post">

          <div class="form-group">
            <label for="codigo">Código:</label>
            <input type="number" name="Codigo" id="codigo" class="form-control" required placeholder="Código" autofocus>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" name="Presentacion" id="presentacion" class="form-control" required placeholder="Presentación">
          </div>
          <div class="form-group">
            <label for="peso">Peso:</label>
            <input type="number" name="Peso" id="peso" class="form-control" required placeholder="Peso">
          </div>
